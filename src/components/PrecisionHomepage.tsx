  ...
  return (
    <main className={styles.page}>
      ...
      <footer className={styles.footer}>
        ...
        <div><strong>Company</strong><Link href="/about">About</Link><Link href="/news">News</Link><Link href="/rider-club">Rider club</Link><Link href="/dealer-program">Dealer program</Link></div>
      </footer>
    </main>
  );
}
